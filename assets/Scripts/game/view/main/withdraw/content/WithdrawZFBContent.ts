...
@ccclass('WithdrawZFBContent')
export class WithdrawZFBContent extends PiterUI {
  ...
  showCardNodeInfo(cardNode: Node, cardData: WithdrawMethodItem) {
    ...
    this.AT_CurCard.getComponent(Label).string = cardData.provider + "(" + cardData.accountAddr + ")"
  ...
  onShowUI() {
    ...
    this.AT_NumEdit.placeholder = `单笔提现最低金额330`
  }
